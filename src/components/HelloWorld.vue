...
computed: {
  // регулирует отображение кнопки "добавить ребенка"
  is_adding_available(){
...
methods: {
  //добавляет ребенка, создавая обьект data, который помещается в массив child обьекта parent
  Another_child(){
  ...
  //парсит обьект parent в JSON после чего записывает в localstorage
  SaveData(){
